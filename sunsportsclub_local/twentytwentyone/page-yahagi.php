            ...
            <div class="tab-content-wrapper">
                    ...
                    <div class="about">
                        <div>
                            <div class="about-photo">
                                <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-master.png" alt="">
                                <div class="about-name">
                                    <p>主任</p>
                                    <p style="margin-left:10%;">上野　美咲</p>
                                </div>
                            </div>
                            <div class="title">水泳を通じて心身の育成を!</div>
                            <div>
                                <p>
                                    当クラブは水泳を通じ、心身の育成、スポーツに対する正しい理解と感心を深め、地域に密着した施設をめざしています。<br>
                                    <br> 指導方針の中でも、最も重視しているのが「泳げないお子様の指導に力を入れ、美しいフォームで泳げるように養成する」とともに、 水泳は生命を守る大切な運動であり「自分も友達も大切にするためのマナーや躾」の指導にも一層心掛けています。そして生徒数に対し、 コーチを出来るだけ多く配置し、安全にも十分配慮するよう努力しています。
                                    <br>
                                    <br> また、私自身もコーチの一員として水に入り、お子様や大人の方々の声を聞き、常に接点を持ち指導に反映させております。 スイミングスクールの内容など、ご質問やご相談、見学などお気軽にお問合せください。専任スタッフが丁寧にお答えいたします。 最新の設備と優秀なコーチ陣を揃え、長年の実績と伝統に培われた技術指導によるスクーリングを是非ご体験くださいますよう、スタッフ一同、心よりお待ち申し上げます。
                                </p>
                            </div>
                        </div>
                        <div>
                            <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-about-1.png" alt="">
                            <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-about-2.png" alt="">
                            <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-about-3.png" alt="">
                            <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-about-4.png" alt="">
                            <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-about-5.png" alt="">
                        </div>
                    </div>
                </div>
                <div id="tab-content-2" class="tab-content">
                    <div class="time-common">
                        ...
                        <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-common.png" alt="">
                    </div>
                ...
                <div id="tab-content-3" class="tab-content">
                    <div class="traffic-map" id="map">
                        <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-map.png" alt="">
                    </div>
                    <div>
                        <b>サンスポーツクラブ矢作　：　<br class="sp"></b>〒444-0943　岡崎市矢作町猫田6-1 フリーダイヤル 0120-37-2002
                    </div>
                    <div class="traffic-map margin-top">
                        <img src="<?php echo get_template_directory_uri();?>/assets/sunsportsclub/img/yahagi-building.jpg" alt="">
                    </div>
                </div>
                ...
                <div id="tab-content-6" class="tab-content">
                    ...
                    <div class="course" style="display:<??>">
                        ...
                        <div class="course-confirm" id = "confirm">
                            ...
                            <button onclick="confirm_y()">確定</button>
                        </div>
                    </div>
                    <?php endif;?>
                    ...
                    if(!in_array('yahagi-information',$child))
                    continue;
                    ?>
